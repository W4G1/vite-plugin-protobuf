  ...
  async function runProtoc() {
    ...
    await Promise.all([
      fs.promises.writeFile(
        ...
        `# Ignore everything because the directory is auto-generated by vite-plugin-protobuf\n# for more info visit https://github.com/W4G1/vite-plugin-protobuf\n*`,
        "utf8",
      ),
      fs.promises.writeFile(
        path.join(outputDir, ".prettierignore"),
        `# Ignore everything because the directory is auto-generated by vite-plugin-protobuf\n# for more info visit https://github.com/W4G1/vite-plugin-protobuf\n*`,
        "utf8",
      ),
      fs.promises.writeFile(
        path.join(outputDir, ".eslintignore"),
        `# Ignore everything because the directory is auto-generated by vite-plugin-protobuf\n# for more info visit https://github.com/W4G1/vite-plugin-protobuf\n*`,
        "utf8",
      ),
    ]);
